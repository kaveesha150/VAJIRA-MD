...
global.owner = process.env.OWNER_NUMBER  || '94789284143' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'qNkUWJaA#iPe_o7GX7rVnLOqMXTKZVATF9WaxWvykWzpwMGCBpAA' ,
